...
#SBATCH --time=0-02:00 # Time limit days-hrs:min
#SBATCH --qos=dferris # -b to use Burst

# Optional Items
#SBATCH --job-name=HSIM_MIM # Job name 
#SBATCH --mail-type=END,FAIL # Mail events 
#SBATCH --mail-user=twiles@ufl.edu # Where to send mail 
#SBATCH --output=HSIM_MIM%j.log # Standard output and error log 
...
Rscript /blue/dferris/twiles/MindInMotion/R/H_Simulation_MIM.R
