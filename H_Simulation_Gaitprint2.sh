...
# Optional Items
#SBATCH --job-name=HSMGP2 # Job name 
#SBATCH --mail-type=END,FAIL # Mail events 
#SBATCH --mail-user=twiles@ufl.edu # Where to send mail 
#SBATCH --output=HSMGP2%j.log # Standard output and error log 
...
Rscript /blue/dferris/twiles/MindInMotion/R/H_Simulation_Gaitprint2.R
