...
#SBATCH --mem=768gb # Job memory request
#SBATCH --distribution=cyclic:cyclic # Distribute tasks cyclically 
#SBATCH --time=0-12:00 # Time limit days-hrs:min
#SBATCH --qos=dferris-b # -b to use Burst

# Optional Items
#SBATCH --job-name=HSMGP1 # Job name 
#SBATCH --mail-type=END,FAIL # Mail events 
#SBATCH --mail-user=twiles@ufl.edu # Where to send mail 
#SBATCH --output=HSMGP1%j.log # Standard output and error log 
...
Rscript /blue/dferris/twiles/MindInMotion/R/H_Simulation_Gaitprint1.R
