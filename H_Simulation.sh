...
# Optional Items
#SBATCH --job-name=H_Simulation # Job name 
#SBATCH --mail-type=END,FAIL # Mail events 
#SBATCH --mail-user=twiles@ufl.edu # Where to send mail 
#SBATCH --output=H_Simulation%j.log # Standard output and error log 
...
Rscript /blue/dferris/twiles/MindInMotion/R/H_Simulation.R
