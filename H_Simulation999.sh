...
#SBATCH --time=0-01:30 # Time limit days-hrs:min
#SBATCH --qos=dferris-b # -b to use Burst

# Optional Items
#SBATCH --job-name=999 # Job name 
#SBATCH --mail-type=END,FAIL # Mail events 
#SBATCH --mail-user=twiles@ufl.edu # Where to send mail 
#SBATCH --output=999%j.log # Standard output and error log 
...
Rscript /blue/dferris/twiles/MindInMotion/R/H_Simulation999.R
