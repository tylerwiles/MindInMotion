...
Where is the most updated demographics sheet?
...
m0.tm.hurst = brms::brm(hurst ~ 1 + terrain * trial + terrain.speed + (1 + terrain + trial|id),
                        data = dat.temp,
                        cores = parallel::detectCores() - 2,
                        chains = 4,
                        iter = 6000,
...
m0.tm.entropy = brms::brm(entropy ~ 1 + terrain * trial + terrain.speed + (1 + terrain + trial|id),
                          data = dat.temp,
                          cores = parallel::detectCores() - 2,
                          chains = 4,
                          iter = 6000,
