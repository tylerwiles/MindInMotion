...
Need to deal with NaN entropies
...
# dat = data.table::fread(here('DATA', 'MIM_Nonlinear_Results_Steps.csv'), header = TRUE)
...
dat = dat[dat$group == 'old' & dat$treadmill == 'TM']

dat = dat[complete.cases(dat[, c("id", "treadmill", "speed", "terrain", "trial", "hurst", "entropy", "functioning", "group")]), ]

table(dat$functioning[!duplicated(dat$id)])

# Is there an interaction between terrain and the functioning of older adults? No. Terrain main effect.
BayesFactor::anovaBF(hurst ~ terrain * functioning, data = dat, whichRandom = 'id', whichModels = 'withmain')

BayesFactor::anovaBF(hurst ~ terrain, data = dat[dat$functioning == 'high.functioning'], whichRandom = 'id', whichModels = 'withmain')
BayesFactor::anovaBF(hurst ~ terrain, data = dat[dat$functioning == 'low.functioning'], whichRandom = 'id', whichModels = 'withmain')

# What are the differences between terrain? Flat is different than all the others.
BayesFactor::ttestBF(x = dat$hurst[dat$terrain == 'flat' & dat$functioning == 'low.functioning'],
                     y = dat$hurst[dat$terrain == 'low' & dat$functioning == 'low.functioning'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat$hurst[dat$terrain == 'flat' & dat$functioning == 'low.functioning'],
                     y = dat$hurst[dat$terrain == 'med' & dat$functioning == 'low.functioning'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat$hurst[dat$terrain == 'flat' & dat$functioning == 'low.functioning'],
                     y = dat$hurst[dat$terrain == 'high' & dat$functioning == 'low.functioning'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat$hurst[dat$terrain == 'low' & dat$functioning == 'low.functioning'],
                     y = dat$hurst[dat$terrain == 'med' & dat$functioning == 'low.functioning'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat$hurst[dat$terrain == 'low' & dat$functioning == 'low.functioning'],
                     y = dat$hurst[dat$terrain == 'high' & dat$functioning == 'low.functioning'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat$hurst[dat$terrain == 'med' & dat$functioning == 'low.functioning'],
                     y = dat$hurst[dat$terrain == 'high' & dat$functioning == 'low.functioning'],
                     paired = FALSE)


BayesFactor::ttestBF(x = dat$hurst[dat$terrain == 'flat' & dat$functioning == 'high.functioning'],
                     y = dat$hurst[dat$terrain == 'low' & dat$functioning == 'high.functioning'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat$hurst[dat$terrain == 'flat' & dat$functioning == 'high.functioning'],
                     y = dat$hurst[dat$terrain == 'med' & dat$functioning == 'high.functioning'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat$hurst[dat$terrain == 'flat' & dat$functioning == 'high.functioning'],
                     y = dat$hurst[dat$terrain == 'high' & dat$functioning == 'high.functioning'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat$hurst[dat$terrain == 'low' & dat$functioning == 'high.functioning'],
                     y = dat$hurst[dat$terrain == 'med' & dat$functioning == 'high.functioning'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat$hurst[dat$terrain == 'low' & dat$functioning == 'high.functioning'],
                     y = dat$hurst[dat$terrain == 'high' & dat$functioning == 'high.functioning'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat$hurst[dat$terrain == 'med' & dat$functioning == 'high.functioning'],
                     y = dat$hurst[dat$terrain == 'high' & dat$functioning == 'high.functioning'],
                     paired = FALSE)


BayesFactor::anovaBF(entropy ~ terrain * functioning, data = dat, whichRandom = 'id', whichModels = 'withmain')

BayesFactor::anovaBF(entropy ~ terrain, data = dat[dat$functioning == 'high.functioning'], whichRandom = 'id', whichModels = 'withmain')
BayesFactor::anovaBF(entropy ~ terrain, data = dat[dat$functioning == 'low.functioning'], whichRandom = 'id', whichModels = 'withmain')

# What are the differences between terrain? Flat is different than all the others.
BayesFactor::ttestBF(x = dat$entropy[dat$terrain == 'flat' & dat$functioning == 'low.functioning'],
                     y = dat$entropy[dat$terrain == 'low' & dat$functioning == 'low.functioning'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat$entropy[dat$terrain == 'flat' & dat$functioning == 'low.functioning'],
                     y = dat$entropy[dat$terrain == 'med' & dat$functioning == 'low.functioning'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat$entropy[dat$terrain == 'flat' & dat$functioning == 'low.functioning'],
                     y = dat$entropy[dat$terrain == 'high' & dat$functioning == 'low.functioning'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat$entropy[dat$terrain == 'low' & dat$functioning == 'low.functioning'],
                     y = dat$entropy[dat$terrain == 'med' & dat$functioning == 'low.functioning'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat$entropy[dat$terrain == 'low' & dat$functioning == 'low.functioning'],
                     y = dat$entropy[dat$terrain == 'high' & dat$functioning == 'low.functioning'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat$entropy[dat$terrain == 'med' & dat$functioning == 'low.functioning'],
                     y = dat$entropy[dat$terrain == 'high' & dat$functioning == 'low.functioning'],
                     paired = FALSE)
...
dat.temp = dat.temp[dat.temp$group == 'old']

dat.temp = dat.temp[complete.cases(dat.temp[, c("id", "treadmill", "speed", "terrain", "trial", "hurst", "functioning", "group")]), ]

set.seed(9152025)

# Is there an interaction between terrain and the functioning of older adults? No. Terrain main effect.
BayesFactor::anovaBF(hurst ~ terrain * functioning, data = dat.temp, whichRandom = 'id', whichModels = 'withmain')

# What are the differences between terrain? Flat is different than all the others.
BayesFactor::ttestBF(x = dat.temp$hurst[dat.temp$terrain == 'flat'],
                     y = dat.temp$hurst[dat.temp$terrain == 'low'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat.temp$hurst[dat.temp$terrain == 'flat'],
                     y = dat.temp$hurst[dat.temp$terrain == 'med'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat.temp$hurst[dat.temp$terrain == 'flat'],
                     y = dat.temp$hurst[dat.temp$terrain == 'high'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat.temp$hurst[dat.temp$terrain == 'low'],
                     y = dat.temp$hurst[dat.temp$terrain == 'med'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat.temp$hurst[dat.temp$terrain == 'low'],
                     y = dat.temp$hurst[dat.temp$terrain == 'high'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat.temp$hurst[dat.temp$terrain == 'med'],
                     y = dat.temp$hurst[dat.temp$terrain == 'high'],
                     paired = FALSE)

# Is there an interaction between young adults and high functioning older adults? Yes.
dat.temp = dat[dat$treadmill == 'TM']
dat.temp = dat.temp[dat.temp$functioning == 'high.functioning']
dat.temp = dat.temp[complete.cases(dat.temp[, c("id", "treadmill", "speed", "terrain", "trial", "hurst", "functioning", "group")]), ]
BayesFactor::anovaBF(hurst ~ terrain * group, data = dat.temp, whichRandom = 'id', whichModels = 'withmain')

# Holding age constant, what is the difference in terrain? Nothing
BayesFactor::anovaBF(hurst ~ terrain, data = dat.temp[dat.temp$group == 'young'], whichRandom = 'id', whichModels = 'withmain')
BayesFactor::anovaBF(hurst ~ terrain, data = dat.temp[dat.temp$group == 'old'], whichRandom = 'id', whichModels = 'withmain')

BayesFactor::ttestBF(x = dat.temp$hurst[dat.temp$group == 'young' & dat.temp$terrain == 'flat'],
                     y = dat.temp$hurst[dat.temp$group == 'old' & dat.temp$terrain == 'flat'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat.temp$hurst[dat.temp$group == 'young' & dat.temp$terrain == 'low'],
                     y = dat.temp$hurst[dat.temp$group == 'old' & dat.temp$terrain == 'low'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat.temp$hurst[dat.temp$group == 'young' & dat.temp$terrain == 'med'],
                     y = dat.temp$hurst[dat.temp$group == 'old' & dat.temp$terrain == 'med'],
                     paired = FALSE)
BayesFactor::ttestBF(x = dat.temp$hurst[dat.temp$group == 'young' & dat.temp$terrain == 'high'],
                     y = dat.temp$hurst[dat.temp$group == 'old' & dat.temp$terrain == 'high'],
                     paired = FALSE)
dat.temp %>%
  group_by(group, terrain) %>%
  summarise(mu = format(round(mean(hurst, na.rm = TRUE), 2), nsmall = 2),
            sds = format(round(sd(hurst, na.rm = TRUE), 2), nsmall = 2),
            .groups = "drop")
...
BF_Simple = function(dat, dv, label) {
  BayesFactor::ttestBF(x = dat[[dv]][dat$label == age.group & dat$gender == 'male'],
                       y = dat[[dv]][dat$label == age.group & dat$gender == 'female'],
                       paired = FALSE)
}



# Are there interactions between terrain, functioning, and age group
BayesFactor::anovaBF(hurst ~ terrain * functioning * group, data = dat.temp, whichRandom = 'id', whichModels = 'withmain')

# Hold age group constant (we cannot investigate young adults only because they were always high functioning)
BayesFactor::anovaBF(hurst ~ terrain * functioning, data = dat.temp[dat.temp$group == 'old'], whichRandom = 'id', whichModels = 'withmain')

# But we can investigate young adults and older adults who are high functioning
BayesFactor::anovaBF(hurst ~ terrain * functioning, data = dat.temp[dat.temp$group == 'young' & dat.temp$functioning == 'high.functioning'], whichRandom = 'id', whichModels = 'withmain')

# Hold Age group constant
BayesFactor::anovaBF(hurst ~ terrain * trial, data = dat.temp[dat$group == 'young'], whichRandom = 'id', whichModels = 'withmain')
