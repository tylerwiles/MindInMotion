...
# Gaitprint dataset, the Hurst exponent is calculated for the final 50, 100,
# 150, 200 strides (when the number of strides allows) and then the time series
# is dropped from 2-10% randomly or contiguously. Each of these combinations of
# time series lengths and % drops are run multiple times (i.e., 100 repetitions)
# but the average of them are exported. This code is written to be run on
# Hipergator but minor changes will run locally.
...
my.directory = "/blue/dferris/twiles/HSIM_DATA/H_Simulation/GAITPRINT"
# my.directory = "R:/Ferris-Lab/twiles/H_Simulation/GAITPRINT" For Testing
...
write.csv(results, here::here("DATA", "H_Simulation", "H_Simulation_Gaitprint.csv"), row.names = FALSE)
