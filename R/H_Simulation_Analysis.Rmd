...
# Remove trials that had manually corrected heel contacts
dat.contacts = data.table::fread(here::here('DATA', 'H_Simulation', 'Gaitprint_fixed_contacts.csv'), header = FALSE)
dat = dat[!id %in% dat.contacts$V1]
