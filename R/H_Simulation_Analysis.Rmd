...
bf.rel$BF10 = log(bf.rel$BF10)
plot(bf.rel$drops[bf.rel$data.version == 'random.diff'], bf.rel$BF10[bf.rel$data.version == 'random.diff'])
plot(bf.rel$strides[bf.rel$data.version == 'random.diff'], bf.rel$BF10[bf.rel$data.version == 'random.diff'])
ggplot(bf.rel[bf.rel$data.version == 'random.diff', ],
       aes(x = strides, y = BF10)) +
  geom_point() +
  facet_wrap(~ drops)
...
summary(m0)
library(emmeans)
emm <- emmeans(m0, ~ drops | data.version)
emm
...
bf.abs$BF10 = log(bf.abs$BF10)
plot(bf.abs$drops[bf.abs$data.version == 'random.diff'], bf.abs$BF10[bf.abs$data.version == 'random.diff'])
plot(bf.abs$strides[bf.abs$data.version == 'random.diff'], bf.abs$BF10[bf.abs$data.version == 'random.diff'])
ggplot(bf.abs[bf.abs$data.version == 'random.diff', ],
       aes(x = strides, y = BF10)) +
  geom_point() +
  facet_wrap(~ drops)
