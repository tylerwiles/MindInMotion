...
hursts = ggplot() +
  ...
  theme(legend.position = "top") +
  ylim(0, 1)
ggsave(filename = 'C:/Users/twiles/Downloads/MIM_SP_hursts_trials.jpeg', plot = hursts,
       dpi = "retina", bg = "white")
...
entropys = ggplot() +
  ...
  theme_classic() +
  theme(legend.position = "top")
ggsave(filename = 'C:/Users/twiles/Downloads/MIM_SP_entropys_trials.jpeg', plot = entropys,
       dpi = "retina", bg = "white")
