...
}xponent. Common practice is to take the median of the probability distribution as the estimated Hurst exponent. For an example of using this algorithm on human movement data, refer to Likens et al. 2023.
//' 
//' @examples
//' # Generate example time series data
//' x = fgn_sim(n = 128, H = 0.9)
...
// bayesH
arma::vec bayesH(arma::vec x, unsigned int n);
RcppExport SEXP sourceCpp_1_bayesH(SEXP xSEXP, SEXP nSEXP) {
BEGIN_RCPP
